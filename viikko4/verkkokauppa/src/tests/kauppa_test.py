...
class TestKauppa(unittest.TestCase):
    ...
    def test_ostetaan_kaksi_eri_tuotetta_joista_toinen_loppu(self):
    ...
    def test_kaksi_eri_ostoskertaa(self):
        ...
        viitegen_mock = Mock()
        viitegen_mock.uusi.side_effect = [1,2]
        ...
        # varmistetaan, että metodia tilisiirto on kutsuttu
        self.pankki_mock.tilisiirto.assert_called_with("pekka", 2, "12345", "33333-44455", 4)
    
    def test_jokaisella_ostolla_oma_viite(self):
    ...
    def test_ostetaan_kaksi_eri_tuotetta_palautetaan_toinen(self):
